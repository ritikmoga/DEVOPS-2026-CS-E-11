...
export async function leaveTeam(teamId, userId) {
  ...
  if (!member) throw new AppError("Team membership not found", 404, "TEAM_MEMBERSHIP_NOT_FOUND");
  if (member.role === "LEADER")
    throw new AppError(
      "The team leader cannot leave; transfer leadership or cancel the team",
      409,
      "LEADER_CANNOT_LEAVE",
    );
